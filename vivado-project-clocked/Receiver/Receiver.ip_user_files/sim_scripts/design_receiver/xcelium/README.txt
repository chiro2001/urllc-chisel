...
#
# Generated by export_simulation on Thu Jun 09 20:48:19 +0800 2022
#
################################################################################
...
'-reset_run' switch to the './design_receiver.sh' script.

./design_receiver.sh -reset_run
...
./design_receiver.sh -noclean_files

For more information on the script, please type './design_receiver.sh -help'.
