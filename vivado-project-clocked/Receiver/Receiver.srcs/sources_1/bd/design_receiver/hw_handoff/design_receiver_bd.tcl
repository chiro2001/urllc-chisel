...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net ReceiverWrapper_0_receiver_ad_clk [get_bd_ports receiver_ad_clk] [get_bd_pins ReceiverWrapper_0/receiver_ad_clk] [get_bd_pins ila_0/probe4]
  connect_bd_net -net ReceiverWrapper_0_receiver_da [get_bd_ports receiver_da] [get_bd_pins ReceiverWrapper_0/receiver_da] [get_bd_pins ila_0/probe3]
  connect_bd_net -net ReceiverWrapper_0_receiver_da_clk [get_bd_ports receiver_da_clk] [get_bd_pins ReceiverWrapper_0/receiver_da_clk] [get_bd_pins ila_0/probe5]
  connect_bd_net -net ReceiverWrapper_0_receiver_sync_out [get_bd_ports receiver_sync_out] [get_bd_pins ReceiverWrapper_0/receiver_sync_out] [get_bd_pins ila_0/probe2]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins ReceiverWrapper_0/clock] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins ila_0/clk]
  ...
  connect_bd_net -net receiver_ad_1 [get_bd_ports receiver_ad] [get_bd_pins ReceiverWrapper_0/receiver_ad] [get_bd_pins ila_0/probe1]
  connect_bd_net -net receiver_sync_in_1 [get_bd_ports receiver_sync_in] [get_bd_pins ReceiverWrapper_0/receiver_sync_in] [get_bd_pins ila_0/probe0]
